declare namespace fgui {
    class AsyncOperation {
        ...
        private _runner;
        private static _asyncRunners;
        static updateRunners(): void;
        createObject(pkgName: string, resName: string, userClass?: any): void;
        createObjectFromURL(url: string): void;
        cancel(): void;
        private internalCreateObject;
        completed(result: GObject): void;
    }
}
declare namespace fgui {
    class Controller extends cc.EventTarget {
        ...
        setAndWaitSelectedIndex(value: number, callback: Function): void;
        ...
        runActions(callback?: Function): void;
        onActionRunDone(): void;
...
declare namespace fgui {
    let NEW_ENGINE_VERSION: string;
    class GObject {
        private static _eventListener;
        data: any;
        ...
        protected _originVisible: boolean;
        ...
        _treeNode: GTreeNode;
        _delayAddFlag: boolean;
        private _hashIdx;
        static _defaultGroupIndex: number;
        private static _gHashIdx;
        private static _touchEventListener;
        static addTouchEventListener(cbFunc: (event: Event, posx: number, posy: number) => {}, thisObj: any): void;
        static _lastEvent: any;
        private static onDispatchEvent;
        static doDispatchEvent(event: cc.Event): void;
        constructor();
        protected genPartner(): void;
        once<T extends Function>(type: string, callback: T, target?: any, useCapture?: boolean): void;
        dispatchEventWith(type: string, bubble?: boolean, data?: any): void;
        readonly id: string;
        ...
        alpha: number;
        visible: boolean;
        saveAndSetVisible(value: boolean): void;
        recoverVisible(): void;
        ...
        protected applyGearDisplay(connected: boolean): void;
        ...
        localToRoot(ax?: number, ay?: number, resultPoint?: cc.Vec2): cc.Vec2;
        rootToLocal(ax?: number, ay?: number, resultPoint?: cc.Vec2): cc.Vec2;
    ...
    class GActivatePartner extends GObjectPartner {
        protected onEnable(): void;
    }
}
declare namespace fgui {
    class GComponent extends GObject {
        ...
        addChildren(children: Array<GObject>): void;
        ...
        applyController(c: Controller, callback?: Function): void;
...
declare namespace fgui {
    class GList extends GComponent {
        ...
        removeItemCallback: (child: GObject) => void;
        ...
        addChildLater(child: GObject): void;
        addChild(child: GObject, delay?: boolean): GObject;
        protected onUpdate(): void;
        addChildAt(child: GObject, index?: number): GObject;
...
declare namespace fgui {
    class GLoader extends GObject {
        ...
        static loadExtenalResFn: (url: string, type: typeof cc.Asset, callback: (err: any, asset: any) => void) => void;
        static freeExtenalResFn: (url: string, type: typeof cc.Asset) => void;
        constructor();
        dispose(): void;
        url: string;
        icon: string;
        ...
        protected loadFromPackage(asset: any): void;
...
declare namespace fgui {
    class GMovieClip extends GObject {
        ...
        setPlaySettings(start?: number, end?: number, times?: number, endAt?: number, endCallback?: Function, callbackObj?: any): void;
        addFrameEvent(frame: number, name: string): void;
        protected handleGrayedChanged(): void;
        getProp(index: number): any;
        setProp(index: number, value: any): void;
        constructFromResource(): void;
...
declare namespace fgui {
    class GTextField extends GObject {
        ...
        protected _cacheMode: cc.Label.CacheMode;
        ...
        protected applyCacheMode(ignoreConstruct?: boolean): void;
        setCacheModeChar(): void;
        setCacheModeBitmap(): void;
        clearCacheMode(): void;
        dispose(): void;
        text: string;
        font: string;
        private _loadBmpFont;
        fontSize: number;
        color: cc.Color;
...
declare namespace fgui {
    ...
    class GRoot extends GComponent {
        ...
        private _scaleAdjust;
        private _playSoundHandler;
        static contentScaleFactor: number;
        private static _inst;
        static orientation: AppOrientation;
        ...
        getDesignViewWidth(): number;
        getDesignViewHeight(): number;
        ...
        hideWindow(win: Window, remove?: boolean): void;
        hideWindowImmediately(win: Window, remove?: boolean): void;
        ...
        hideTooltips(): void;
        volumeScale: number;
        playSoundHandler: (name: string, volumeScale?: number) => void;
...
declare namespace fgui {
    class GSlider extends GComponent {
        ...
        canDrag: boolean;
        titleChangeHandler: (val: number) => string;
        valueWrapper: (val: number, percent: number) => number;
        constructor();
        titleType: ProgressTitleType;
...
declare namespace fgui {
    class GTextInput extends GTextField {
        _editBox: cc.EditBox;
        private _promptText;
        private static TextInputListener;
        static addEditBoxInputListener(cbFunc: Function): void;
        static clearBoxInputListener(): void;
        private static _onKeyboardEvent;
        constructor();
        protected createRenderer(): void;
        editable: boolean;
        maxLength: number;
...
declare namespace fgui {
    class PackageItem {
        ...
        extensionType: any;
        constructor();
        setup(buffer: ByteBuffer, url: string): void;
        private _listeners;
        onLoad(onComplete: (asset: cc.Texture2D | cc.SpriteFrame | cc.AudioClip | cc.LabelAtlas) => void, thisArgs: any): void;
        protected _doLoad(callback: (asset: any) => void): void;
        offLoad(onComplete: Function, thisArgs: any): void;
        load(): any;
        getBranch(): PackageItem;
        getHighResolution(): PackageItem;
        toString(): string;
        getSizeRateInAtlas(): cc.Vec2;
    }
    class PackageImageItem extends PackageItem {
        setup(buffer: ByteBuffer): void;
        protected _doLoad(callback: (asset: any) => void): void;
    }
    class PackageMovieClipItem extends PackageItem {
        setup(buffer: ByteBuffer, url: string): void;
        private _loadFrame;
        protected _doLoad(callback: (asset: any) => void): void;
    }
    class PackageFontItem extends PackageItem {
        setup(buffer: ByteBuffer, url: string): void;
        private _assembleFont;
        private _tryLoadTexture;
        protected _doLoad(callback: (asset: any) => void): void;
    }
    class PackageComponentItem extends PackageItem {
        setup(buffer: ByteBuffer, url: string): void;
        protected _doLoad(callback: (asset: any) => void): void;
    }
    class PackageAtlasItem extends PackageItem {
        setup(buffer: ByteBuffer, url: string): void;
        protected _doLoad(callback: (asset: any) => void): void;
    }
    class PackageSoundItem extends PackageItem {
        setup(buffer: ByteBuffer, url: string): void;
        protected _doLoad(callback: (asset: any) => void): void;
    }
    class PackageMiscItem extends PackageItem {
        setup(buffer: ByteBuffer, url: string): void;
        protected _doLoad(callback: (asset: any) => void): void;
    }
}
...
declare namespace fgui {
    class Transition {
        ...
        clearHooks(): void;
        setTransitionItemEndXYByLabel(label: string, x: number, y: number): void;
        setTransitionItemBeginXYByLabel(label: string, x: number, y: number): void;
...
declare namespace fgui {
    class UIConfig {
        ...
        static listDragReleaseTriggerSensitivity: number;
...
declare namespace fgui {
    class UIPackage {
        ...
        static loadPackage(url: string, loadRes: boolean, completeCallback: ((error: any) => void) | null): void;
        static getPackage(packageIdOrName: string): UIPackage;
...
declare namespace fgui {
    class Window extends GComponent {
        ...
        hideImmediately(remove?: boolean): void;
        ...
        protected doHideAnimation(remove?: boolean): void;
...
declare namespace fgui {
    ...
    class MovieClip extends Image {
        ...
        advance(timeInMiniseconds: number): void;
        registerFrameCallback(callback: Function, callbackObj: any): void;
        setPlaySettings(start?: number, end?: number, times?: number, endAt?: number, endCallback?: Function, callbackObj?: any): void;
        protected update(dt: number): void;
        private callDrawFrameCallback;
        private drawFrame;
    }
}
declare namespace fgui {
...
declare namespace fgui {
    export class InputProcessor extends cc.Component {
        ...
        constructor();
        static addTouchEventListener(cbFunc: (event: Event, posx: number, posy: number) => {}, thisObj: any): void;
        static clearEventListener(): void;
        private static onDispatchEvent;
        onLoad(): void;
        onEnable(): void;
        onDisable(): void;
        ...
        simulateTouchBegin(touch: cc.Touch, target: fgui.GObject): boolean;
        simulateTouchMove(touch: cc.Touch, target: fgui.GObject): void;
        simulateTouchEnd(touch: cc.Touch, target: fgui.GObject): void;
        simulateTouchCancel(touch: cc.Touch, target: fgui.GObject): void;
        simulateTouchBegin1(touch: cc.Touch, target: fgui.GObject): boolean;
        ...
        updateInfo(touchId: number, pos: cc.Vec2, touch?: cc.Touch): TouchInfo;
        private getInfo;
        private setBegin;
        private setEnd;
        private clickTest;
    ...
    class TouchInfo {
        ...
        lastRollOver: GObject;
        downTargets: Array<GObject>;
        touchMonitors: Array<GObject>;
        activating: boolean;
    }
    export {};
}
...
declare namespace fgui {
    class UBBParser {
        ...
        protected onTag_OUTLINE(tagName: string, end: boolean, attr: string): string;
