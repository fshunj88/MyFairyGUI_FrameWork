...
namespace fgui {
    export class ScrollPane extends cc.Component {
        ...
        private onTouchMove(evt: Event): void {
            ...
            var touchPos = evt.touch.getLocation();
            var scale = fgui.GRoot.contentScaleFactor;
            var pt: cc.Vec2 = ScrollPane.sHelperPoint = cc.v2(touchPos.x/scale, -touchPos.y/scale);
        ...
        private onTouchEnd(evt: Event): void {
            ...
            if (flag) {
                ...
                if (this._tweenChange.x < -UIConfig.listDragReleaseTriggerSensitivity || this._tweenChange.y < -UIConfig.listDragReleaseTriggerSensitivity) {
                ...
                else if (this._tweenChange.x > UIConfig.listDragReleaseTriggerSensitivity || this._tweenChange.y > UIConfig.listDragReleaseTriggerSensitivity) {
                    this._refreshEventDispatching = true;
