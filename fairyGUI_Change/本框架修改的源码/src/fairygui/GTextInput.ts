...
namespace fgui {
    export class GTextInput extends GTextField {
        ...
        public static addEditBoxInputListener (cbFunc: Function) {
            GTextInput.TextInputListener.push({callback: cbFunc});
        };

        public static clearBoxInputListener() {
            GTextInput.TextInputListener = [];
        }

        private static _onKeyboardEvent(value: string, type: string, edit: GObject) {
            GTextInput.TextInputListener.forEach((listener) => {
