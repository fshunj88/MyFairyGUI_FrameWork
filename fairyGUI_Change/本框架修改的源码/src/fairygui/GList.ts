...
namespace fgui {
    ...
    class GListPartner extends GObjectPartner {
        protected update(dt) {
    ...
    export class GList extends GComponent {
        ...
        public removeItemCallback: (child: GObject) => void;
        ...
        private _delayAddChildren: Array<GObject>;
        private _delayDirty: boolean;
        ...
        public set itemPool(pool: GObjectPool) {
            if (this._pool) {
                this._pool.clear();
            }
            this._pool = pool;
        ...
        public addChildLater(child: GObject): void {
            var c = child;
            var self = this;
        ...
        public addChild(child: GObject, delay: boolean = true,): GObject {
        ...
        protected onUpdate() {
            ...
            let clen = this._children.length;
            var i = 0;
            for (; i < cnt; ++ i) {
        ...
        public addItem(url: string = null): GObject {
            ...
            return this.addChild(UIPackage.createObjectFromURL(url), false);
        }
        ...
        public removeChildAt(index: number, dispose?: boolean): GObject {
            var child: GObject = super.removeChildAt(index, false);
            if (!dispose) {
        ...
        public isChildInView(child: GObject): boolean {
            if (!child.visible && this.foldInvisibleItems) return false;
            return super.isChildInView(child);
        }
        ...
        private _renderItem(i: number, obj: GObject) {
