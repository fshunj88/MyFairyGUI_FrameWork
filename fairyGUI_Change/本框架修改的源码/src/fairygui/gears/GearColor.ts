...
namespace fgui {
    ...
    export class GearColor extends GearBase {
        ...
        protected init(): void {
            this._default = new GearColorValue(this._owner.getProp(ObjectPropID.Color),
                ...
                this._owner.getProp(ObjectPropID.ShadowColor));
            this._storage = {};
        }
        ...
        public apply(): void {
            ...
            if (gv.shadowColor != null)
                this._owner.setProp(ObjectPropID.ShadowColor, gv.shadowColor);
        ...
        public updateState(): void {
            ...
            gv.shadowColor = this._owner.getProp(ObjectPropID.ShadowColor);
        }
    }
    ...
    class GearColorValue {
        ...
        public shadowColor: cc.Color;

        public constructor(color: cc.Color = null, strokeColor: cc.Color = null, shadowColor: cc.Color = null) {
            this.color = color;
