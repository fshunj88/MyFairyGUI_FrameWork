...
namespace fgui {
    ...
    export class GLoader extends GObject {
        ...
        public static loadExtenalResFn: (url: string, type: typeof cc.Asset, callback: (err, asset) => void) => void;
        public static freeExtenalResFn: (url: string, type: typeof cc.Asset) => void;
        ...
        public constructor() {
            ...
            this._fill = LoaderFillType.ScaleFree;
        ...
        protected loadContent(): void {
            ...
            if (ToolSet.startsWith(this._url, "ui://")) {
                this._contentItem = UIPackage.getItemByURL(this._url); 
                if (this._contentItem != null) {
        ...
        protected loadFromPackage(asset: any) {
            let itemURL = this._url;
            if (this._contentItem != null) {
        ...
        protected loadExternal(): void {
            ...
            if (GLoader.loadExtenalResFn) {
                ...
                if (ToolSet.startsWith(this._exUrl, "http://") || ToolSet.startsWith(this._exUrl, "https://"))
        ...
        protected freeExternal(texture: cc.SpriteFrame): void {
            if (GLoader.freeExtenalResFn) {
                // console.log("[GLoader.freeExternal] texture = ", texture, this._exUrl);
